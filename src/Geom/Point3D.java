...
public class Point3D implements Geom_element, Serializable 
{
	...
	public Point3D(String[] s, int index_X, int index_Y, int index_Z) {
		for (int i = 0; i < s.length; i++) {
			_x = Double.parseDouble(s[index_X]);
			_y = Double.parseDouble(s[index_Y]);
			_z = Double.parseDouble(s[index_Z]);
		}
	}
	///////////////////////////////////////////////////////////////////////////
	////////////////////////////       methods        /////////////////////////
