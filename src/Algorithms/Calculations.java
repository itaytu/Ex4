...
public class Calculations {
    ...
    private void createBlockObjects() {
        for (Block b : game.getBlockArrayList()) {
            ...
            LeftTop[0] = LeftTop[0]-4;
            LeftTop[1] = LeftTop[1]-4;
            ...
            RightTop[0] = RightTop[0]+4;
            RightTop[1] = RightTop[1]-4;
            ...
            RightBottom[0] = RightBottom[0]+4;
            RightBottom[1] = RightBottom[1]+4;
            ...
            LeftBottom[0] = LeftBottom[0]-4;
            LeftBottom[1] = LeftBottom[1]+4;
